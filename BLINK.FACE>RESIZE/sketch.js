let x, y;
const REDIRECT_SKETCH_URL = 'http://www.google.com' // @TODO - replace with real url
...
canvasNode = document.getElementsByTagName('canvas')[0];
...
noLoop()
// window.location.href = REDIRECT_SKETCH_URL @TODO // uncomment to make redirect work
return
}
background(255);
ellipseMode(CENTER);
